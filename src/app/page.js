        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-purple-600">
            <div className="flex items-center">
              <div className="h-10 w-10 bg-white rounded-lg flex items-center justify-center text-2xl">
                {icons.scissors}
              </div>
              <div className="ml-3">
                <h1 className="text-lg font-bold text-white">Wearquery</h1>
...
const OrdersView = () => {
  const { orders, setShowOrderModal } = useApp();
...
export default SimpleWearquery;
